...
**Liv is a place for your life that arrives already organised — so you can
put anything in it in two seconds and still find it later.**

## The problem

Two tools exist, and both fail the same person.

The simple ones (notes apps, to-do apps) take things instantly but can't
hold anything complicated. Six months later you have four hundred notes
and no way through them.

The powerful ones — Notion above all — can hold anything, but hand you an
empty page and expect you to design your own system first. Most people
build something elaborate, use it for three weeks, and abandon it. Not
because they're lazy: because designing an information system is a real
skill, and it isn't the job they came to do.

**Liv's bet: the second kind of tool, with the system already made.**
...
1. **You reach for it first.** A thought arrives and Liv is the reflex —
   not the notes app, not a message to yourself.
2. **The pile doesn't build up.** Most of what you catch ends up findable
   without a sorting session. If tidying is a chore you have to schedule,
   the furniture is wrong.
3. **You go back.** Not just adding — finding things again, and looking at

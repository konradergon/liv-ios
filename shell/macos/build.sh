...
mkdir -p build
swiftc -O \
    Sources/main.swift Sources/Window.swift Sources/Editor.swift Sources/Tokens.swift Sources/Commands.swift Sources/Dialogs.swift Sources/Chrome.swift Sources/Spaces.swift Sources/Tabs.swift Sources/Calendar.swift \

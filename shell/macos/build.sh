...
mkdir -p build
swiftc -O \
    Sources/main.swift Sources/Window.swift Sources/Editor.swift Sources/Tokens.swift Sources/Commands.swift Sources/Dialogs.swift Sources/Chrome.swift Sources/Spaces.swift Sources/Tabs.swift Sources/Calendar.swift Sources/Hues.swift Sources/RowKit.swift Sources/DigitMap.swift Sources/InspectorLayout.swift Sources/Inspector.swift Sources/InspectorEditors.swift Sources/Import.swift Sources/Export.swift Sources/Halo.swift Sources/Graph.swift Sources/VaultGraph.swift Sources/Dashboard.swift Sources/Capture.swift Sources/Themes.swift Sources/Settings.swift Sources/PropertyActions.swift Sources/Onboarding.swift \

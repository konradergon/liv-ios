                    ...
                    if let id = drawnDoc {
                        ...
                        EntityTabBody(id: id).id(id).livSurface(LivSurface.document)
                            ...
                            .overlay(alignment: .top) {
                                LivGrabber()
                                    // CENTRED IN THE DOORS' ROW, level
                                    // with the library door and the •••.
                                    //
                                    // It was moved up flush under the
                                    // clock on 2026-09-18 to open the
                                    // view behind sooner, and moved
                                    // straight back on sight: 16pt
                                    // higher bought nothing, because how
                                    // much you reveal is how far you
                                    // drag, not where you take hold. The
                                    // row is where a mark that is chrome
                                    // belongs.
